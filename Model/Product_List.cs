...
namespace ZYL.Core.Model
{
   ...
   public partial class Product_List
   {
      ...
      /// <summary>
      /// 是否认证(0未认证，1商家已认证，2审核中，3认证失败 4 驳回)
      /// </summary>
      ...
      /// <summary>
      /// 运费类型 （0,1,2,3) 逗号隔开 0 表示堂食/免物流，1 快递，2 送货上门，3 自提
      /// </summary>
      public string ExpressGroup { get; set; }
   
      /// <summary>
      /// 针对快递类型对应的配送方式内容 1、快递-> 包邮 填 0，到付 填 0，统一运费 填运费金额，模板 填模板Id {"ExpressGroup":1,"ExpressType":"包邮ID","ExpressFee":0}
      /// </summary>
      ...
      /// <summary>
      /// 品牌Id 关联（Shop_Product_BrandType）- 快消
      /// </summary>
      ...
      ///  百分比，比如填 30 表示 30% - 快消
      /// </summary>
      public int? AutoFullRate { get; set; }
   
      /// <summary>
      /// 是否启用 自动补货 - 快消
      /// </summary>
      public int? IsAutoFull { get; set; }
   
      /// <summary>
      /// 预警设置百分比或值（根据预警类型） IsAutoFull = 0 可用 - 快消
      /// </summary>
      public int? WarnStock { get; set; }
   
      /// <summary>
      /// 预警库存值  0 表示百分比， 1 表示 预警库存值 - 快消
      /// </summary>
      ...
      /// 是否充足库存量 1 充足
      /// </summary>
      public int? IsFullStock { get; set; }
